...
If you experience bugs or general issues with ``nuclear``, please have a look
...
You can help improve ``nuclear`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``nuclear`` documentation uses Sphinx_ as its main documentation compiler.
...
.. _repository: https://github.com/<USERNAME>/nuclear
.. _issue tracker: https://github.com/<USERNAME>/nuclear/issues
.. <-- end -->
